...
#define QTD_CARTAS 2                   // Define a quantidade de cartas que serão comparadas
#define QTD_ATRIBUTOS_COMPARAR 2       // Define a quantidade de atributos que serão comparados
